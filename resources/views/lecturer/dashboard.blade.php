        ...
        <div class="col-md-6">
            <div class="card shadow">
                <div class="card-body">
                    ...
                    <p class="card-text">
                        @if(isset($todayAttendanceCount))
                            You have marked attendance for <strong>{{ $todayAttendanceCount }}</strong> student{{ $todayAttendanceCount == 1 ? '' : 's' }} today.
                        @else
                            Attendance data not available.
                        @endif
                    </p>
                    <a href="{{ route('lecturer.attendance.reports') }}" class="btn btn-info">View Full Reports</a>
                </div>
            </div>
        </div>
